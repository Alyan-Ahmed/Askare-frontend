...
const summaryData = {
  vance: { doctor: 'Dr. Julian Vance', date: 'Sep 12, 2025', time: '10:30 AM', duration: '24m 15s', illness: 'Mild Hypertension with elevated LDL cholesterol levels. Blood pressure readings averaging 138/88 mmHg over the past two weeks.', recommendations: 'Continue monitoring blood pressure twice daily. Maintain a low-sodium diet (less than 2,300mg sodium/day) and increase physical activity to at least 30 minutes of moderate exercise daily. Reduce stress through mindfulness and adequate sleep. Schedule a follow-up in 3 months for re-evaluation.', medicines: [{ name: 'Lisinopril 10mg', dosage: 'Once daily (Morning)' }, { name: 'Atorvastatin 20mg', dosage: 'Once daily (Before bed)' }, { name: 'Aspirin 75mg', dosage: 'Once daily (After lunch)' }], precautions: ['Avoid excessive salt and processed food intake', 'Monitor blood pressure at home twice daily and log readings', 'Limit caffeine to 1-2 cups per day', 'Avoid strenuous exercise without medical clearance', 'Report any dizziness, persistent headaches, or vision changes immediately'], type: 'Video Consultation', typeIcon: 'videocam' },
  patel: { doctor: 'Dr. Sarah Patel', date: 'Jul 4, 2025', time: '02:15 PM', duration: '18m 42s', illness: 'Routine ophthalmology examination. Mild dry eye syndrome noted with slight astigmatism in left eye.', recommendations: 'Use preservative-free artificial tears 3-4 times daily for dry eye relief. Consider blue-light filtering glasses for prolonged screen use. Follow the 20-20-20 rule. Annual comprehensive eye exams recommended.', medicines: [{ name: 'Systane Ultra Eye Drops', dosage: '3-4 times daily (As needed)' }, { name: 'Omega-3 Fish Oil 1000mg', dosage: 'Twice daily (With meals)' }], precautions: ['Avoid rubbing your eyes excessively', 'Reduce screen time to 6 hours maximum per day', 'Wear UV-protection sunglasses outdoors', 'Maintain adequate hydration (8+ glasses of water daily)', 'If vision blurs or worsens, seek immediate consultation'], type: 'Video Consultation', typeIcon: 'videocam' },
  hypertension: { doctor: 'Dr. Arsalan Khan', date: 'Present — Ongoing', time: '11:00 AM', duration: '32m 08s', illness: 'Stage 1 Hypertension — Blood pressure consistently reading 140/90 mmHg. Active monitoring and lifestyle management plan in place.', recommendations: 'Maintain daily blood pressure log. Follow a DASH diet with reduced sodium intake. Engage in 30 minutes of moderate exercise 5 days per week.', medicines: [{ name: 'Amlodipine 5mg', dosage: 'Once daily (Morning)' }, { name: 'Losartan 50mg', dosage: 'Once daily (Evening)' }], precautions: ['Monitor blood pressure twice daily', 'Avoid high-sodium and processed foods', 'Do not skip medication doses', 'Report any chest pain, severe headache, or vision changes immediately', 'Attend quarterly check-ups for dose adjustments'], type: 'Video Consultation', typeIcon: 'videocam' },
  amoxicillin: { doctor: 'Dr. Arsalan Khan', date: 'Aug 20, 2025', time: '09:45 AM', duration: '15m 30s', illness: 'Upper respiratory tract infection with secondary bacterial sinusitis.', recommendations: 'Complete the full 10-day antibiotic course even if symptoms improve. Rest adequately and increase fluid intake.', medicines: [{ name: 'Amoxicillin 500mg', dosage: 'Three times daily (Every 8 hours)' }, { name: 'Paracetamol 500mg', dosage: 'As needed for fever/pain (Max 4/day)' }, { name: 'Saline Nasal Spray', dosage: '2-3 sprays per nostril as needed' }], precautions: ['Complete the full antibiotic course', 'Avoid dairy products within 1 hour of taking antibiotics', 'Stay hydrated with at least 8 glasses of water daily', 'Avoid cold and dusty environments', 'Consult doctor if rash or allergic reaction occurs'], type: 'Video Consultation', typeIcon: 'videocam' },
  prednisone: { doctor: 'Dr. Sarah Patel', date: 'May 12, 2025', time: '03:00 PM', duration: '22m 10s', illness: 'Severe allergic dermatitis with widespread urticaria.', recommendations: 'Follow the tapering schedule strictly. Monitor for signs of adrenal insufficiency.', medicines: [{ name: 'Prednisone 40mg (tapering)', dosage: 'Reducing by 5mg every 3 days' }, { name: 'Cetirizine 10mg', dosage: 'Once daily (Evening)' }, { name: 'Hydrocortisone Cream 1%', dosage: 'Apply to affected areas twice daily' }], precautions: ['Never stop prednisone abruptly', 'Watch for mood changes, insomnia, or increased appetite', 'Avoid contact with people who have infections', 'Take with food to reduce stomach irritation', 'Report any unusual swelling or weight gain'], type: 'Video Consultation', typeIcon: 'videocam' },
  influenza: { doctor: 'Dr. Julian Vance', date: 'Jan 18, 2025', time: '11:30 AM', duration: '19m 55s', illness: 'Seasonal Influenza (Type A) — High fever, body aches, sore throat, fatigue.', recommendations: 'Complete antiviral course within 48 hours. Bed rest for 5-7 days minimum.', medicines: [{ name: 'Oseltamivir (Tamiflu) 75mg', dosage: 'Twice daily for 5 days' }, { name: 'Ibuprofen 400mg', dosage: 'Every 6-8 hours as needed for fever' }, { name: 'Throat Lozenges', dosage: 'As needed for sore throat relief' }], precautions: ['Self-isolate for at least 5 days', 'Wash hands frequently', 'Stay hydrated', 'Avoid strenuous activity', 'Seek emergency care if breathing becomes difficult'], type: 'Video Consultation', typeIcon: 'videocam' },
  vitamind: { doctor: 'Dr. Sarah Patel', date: 'Nov 8, 2024', time: '04:00 PM', duration: '12m 20s', illness: 'Vitamin D Deficiency — Serum level at 12 ng/mL (severely deficient).', recommendations: 'High-dose Vitamin D3 supplementation for 8 weeks followed by maintenance dose.', medicines: [{ name: 'Vitamin D3 50,000 IU', dosage: 'Once weekly for 8 weeks' }, { name: 'Calcium 500mg + D3', dosage: 'Twice daily (With meals)' }], precautions: ['Take Vitamin D with a fatty meal for better absorption', 'Do not exceed recommended supplementation dose', 'Monitor for signs of hypercalcemia', 'Maintain regular outdoor activity', 'Follow up for blood level recheck in 3 months'], type: 'Video Consultation', typeIcon: 'videocam' },
}
            ...
            <div className="p-8">
              {data ? (
                <>
                  ...
                  <div className="flex justify-between items-start mb-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-secondary">AI-Generated Report • {data.doctor}</p>
                      </div>
                    </div>
                  ...
                  {/* Date & Duration — same as post-call */}
                  <div className="flex items-center gap-4 mb-6 text-sm text-secondary">
                    <span className="flex items-center gap-1.5"><span className="material-symbols-outlined text-base">calendar_today</span>{data.date}</span>
                    <span className="flex items-center gap-1.5"><span className="material-symbols-outlined text-base">schedule</span>{data.time}</span>
                    <span className="flex items-center gap-1.5"><span className="material-symbols-outlined text-base">timer</span>{data.duration}</span>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="bg-surface-container-low rounded-xl p-5">
                      ...
                      <p className="text-sm text-on-surface leading-relaxed">{data.illness}</p>
                    </div>
                    {/* Recommendations */}
                    <div className="bg-surface-container-low rounded-xl p-5">
                      ...
                      <p className="text-sm text-on-surface leading-relaxed">{data.recommendations}</p>
                    </div>
                    {/* Medicines */}
                    <div className="bg-surface-container-low rounded-xl p-5">
                      ...
                      <div className="space-y-2">
                        {data.medicines.map((m, i) => (
                          <div key={i} className="flex items-center gap-2 text-sm text-on-surface"><span className="w-1.5 h-1.5 rounded-full bg-primary shrink-0"></span><span className="font-medium">{m.name}</span><span className="text-secondary ml-auto">{m.dosage}</span></div>
                        ))}
                      </div>
                    </div>
                    {/* Precautions */}
                  ...
                  <button onClick={() => setModal(null)} className="w-full mt-8 py-3.5 bg-primary text-on-primary rounded-xl text-sm font-bold hover:opacity-90 transition-all">Got it — Close Summary</button>
                </>
              ) : (
                <>
                  <div className="flex justify-between items-start mb-6">

    ...
    <main className="pt-20 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-8 mb-40">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-10 bg-surface-container-low rounded-[2rem] flex flex-col justify-between min-h-[320px]">
          ...
          <div className="p-10 bg-primary text-on-primary rounded-[2rem] flex flex-col justify-between min-h-[320px]">
          ...
          <div className="p-10 bg-surface-container-high rounded-[2rem] flex flex-col justify-between min-h-[320px]">
      ...
      <section className="bg-surface-container-low py-32 rounded-[3rem] mb-40">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-surface-container-lowest p-8 rounded-3xl transition-transform hover:-translate-y-2">
      ...
      {/* Trust & Safety Banner */}
      <section className="max-w-7xl mx-auto px-8 mb-40">
        <div className="bg-primary p-12 lg:p-20 rounded-[3rem] text-on-primary relative overflow-hidden">
